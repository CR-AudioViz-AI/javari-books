...
export function getActions() {
  return [
    ...
    { id: 'author_research',      label: '✍️ Author Deep Dive',     desc: 'Research an author's life and work',   buildPrompt: function(v) { return 'Create a comprehensive profile of author ' + (v.author||'') + '. Cover: biography, major works, writing style, themes, literary influences, awards, best books to start with, chronological reading order, and cultural impact.' } },
